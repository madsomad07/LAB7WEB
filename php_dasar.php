...
<form action="#" method="post">
    ...
    <select name="Pekerjaan">
        ...
        <option value="Cleaning Service">Ofice Boy</option>
    </select>
...
if(isset($_POST['submit'])){
    ...
    }elseif($selected_val == "Desainer"){
        echo " pekerjaan saya " .$selected_val ." Gaji saya Rp. 5.000.000,-";
    }elseif($selected_val == "Engginering"){
        echo " pekerjaan saya " .$selected_val ." Gaji saya Rp. 12.000.000,-";
    }else{
        echo " pekerjaan saya " .$selected_val ." Gaji saya Rp. 6.000.000,-";}}
 ?>
</body>
</html>